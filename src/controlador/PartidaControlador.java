...
/**
 * Controlador para gestionar la lógica de una partida en el juego de Buscaminas.
...
public class PartidaControlador {
    ...
    /**
     * Constructor que inicializa el controlador con un jugador, un tablero y una vista.
     *
    ...
    /**
     * Constructor que inicializa el controlador creando un jugador y un tablero con los parámetros especificados.
     * También genera las minas y asigna números a los casilleros.
     *
    ...
    /**
     * Inicializa la partida utilizando la vista para mostrar los elementos iniciales al jugador.
     */
